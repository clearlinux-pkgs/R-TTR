...
Version  : 0.24.1
Release  : 43
URL      : https://cran.r-project.org/src/contrib/TTR_0.24.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/TTR_0.24.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598642496
